/*
  ...
  - The values [PICKUP] on the enum `ConsumptionMethod` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ConsumptionMethod_new" AS ENUM ('DELIVERY', 'TAKEAWAY', 'DINE_IN');
